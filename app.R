...
# This should then produce a series of graphs, tables and worded paragraphs to jsutify the test chosen. Eventually a SLM could
# be built underneath the application to produce summary text for scientific papers.